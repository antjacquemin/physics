...
(define (pendule)
  (set! WORLD '())
  (set! CLOCK (/ 1. 100))
  (set! WORLD (cons (new masse% (ray 20) (masse 1) (couleur "cyan") (position (make-vect 25 (/ HEIGHT 2))) (vitesse (make-vect -1 0))) WORLD))
  (set! WORLD (cons (new masse% (ray 20) (masse 1) (couleur "cyan") (position (make-vect 175 (/ HEIGHT 2))) (vitesse (make-vect 0 0))) WORLD))
  (set! WORLD (cons (new masse% (ray 20) (masse 1) (couleur "cyan") (position (make-vect 215 (/ HEIGHT 2))) (vitesse (make-vect 0 0))) WORLD))
  (set! WORLD (cons (new masse% (ray 20) (masse 1) (couleur "cyan") (position (make-vect 255 (/ HEIGHT 2))) (vitesse (make-vect 0 0))) WORLD))
  (set! WORLD (cons (new masse% (ray 20) (masse 1) (couleur "cyan") (position (make-vect 295 (/ HEIGHT 2))) (vitesse (make-vect 0 0))) WORLD)))
