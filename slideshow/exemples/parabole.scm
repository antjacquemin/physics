...
;modification de la taille de la boule
(define MB
  (new button%
       (parent HPANEL)
       (label "Change B")
...
;modification aléatoire de la vitesse de la boule
(define MV
  (new button%
       (parent HPANEL)
...
;modification de la vitesse de la boule qui devient nulle
(define VB0
  (new button%
       (parent HPANEL)
       (label "VitesseB=0")
...
(define (init-world)
  ...
  (masse masseb 400 140 vb 0 "blue"))
